...
export default function MenEditorialBanners() {
  return (
    <section className="py-10 sm:py-14 bg-[#f8f8f8]">
          ...
          {BANNERS.map((banner, i) => (
            <motion.div key={banner.id}
              ...
              <Link href={banner.href}
                className="group relative flex overflow-hidden bg-bone h-[280px] sm:h-[360px] lg:h-[440px] block w-full">
                <Image src={banner.image} alt={banner.title} fill sizes="100vw"
