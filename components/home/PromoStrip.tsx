      ...
      <div className="max-w-full mx-auto h-10 flex items-center justify-center relative">
        {MESSAGES.map((msg, i) => (
          <Link
            key={i}
            href={msg.href}
            className={`absolute inset-0 flex items-center justify-center font-body text-[10px] sm:text-xs tracking-[0.25em] font-medium transition-all duration-500 hover:text-bone ${
              i === idx
