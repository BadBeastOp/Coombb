  ...
  return (
    ...
    >
      <Link href="/home-decor"
        className="block relative overflow-hidden bg-[#f7f7f5] w-full"
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1 z-10">
          {product.isNew && (
            <span className="font-body text-[9px] tracking-[0.15em] bg-charcoal text-white px-2 py-0.5">NEW</span>
          )}
          {product.isSale && (
        ...
        <button
          ...
          className="absolute top-2 right-2 w-8 h-8 bg-white/90 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 hover:bg-white z-10 shadow-sm"
          aria-label="Wishlist">
      ...
      <div className="mt-3">
        ...
        <div className="flex items-center gap-2 mt-1.5">
          ...
          {product.originalPrice && (
            <span className="font-body text-sm text-stone line-through">€{product.originalPrice}</span>
          )}
        </div>
      </div>
    </div>
