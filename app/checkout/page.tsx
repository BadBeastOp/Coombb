    ...
    <>
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 pt-8 pb-16 min-h-screen">
        ...
        <div className="flex items-center justify-between mb-10">
          <Link href="/" className="font-display text-2xl tracking-widest-2">MAISON</Link>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input required value={form.firstName} onChange={(e) => update("firstName", e.target.value)}
                        className="w-full border border-bone px-4 py-3 font-body text-sm focus:outline-none focus:border-charcoal transition-colors" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <select value={form.country} onChange={(e) => update("country", e.target.value)}
                      className="w-full border border-bone px-4 py-3 font-body text-sm focus:outline-none focus:border-charcoal bg-white transition-colors">
              ...
              {step === "payment" && (
                ...
                >
                  ...
                  <div>
                    ...
                    <input required placeholder="1234 5678 9012 3456" value={form.cardNumber}
