...
export default function CartPage() {
    ...
    return (<>
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 pt-8 pb-16 min-h-screen">
        ...
        {items.length === 0 ? (<div className="text-center py-24">
          ...
          </div>) : (<div className="grid lg:grid-cols-12 gap-10 lg:gap-16">
            {/* Items */}
            <div className="lg:col-span-7">
              {items.map((item, i) => (<motion.div key={`${item.product.id}-${item.selectedColor}-${item.selectedSize}`} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }} className="flex gap-5 py-6 border-b border-bone">
            ...
            <div className="lg:col-span-5">
              <div className="bg-cream p-8 sticky top-24">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {totalPrice < 150 && (<p className="font-body text-xs text-stone">
