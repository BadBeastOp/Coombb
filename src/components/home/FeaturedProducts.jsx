...
export default function FeaturedProducts({ featuredProducts }) {
  ...
  // Use provided featuredProducts or empty array fallback
  const trending = featuredProducts?.length ? featuredProducts : [];

  return (
    <section className="py-10 sm:py-14 lg:py-16 bg-[#F7F7F7]">
