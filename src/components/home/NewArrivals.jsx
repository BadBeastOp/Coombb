    ...
    return (<section className="py-10 sm:py-14 lg:py-16 bg-white">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex items-end justify-between mb-7 sm:mb-9">
          ...
          <Link href="/new" className="font-body text-xs tracking-[0.2em] text-stone hover:text-charcoal transition-colors border-b border-stone/40 hover:border-charcoal pb-0.5 hidden sm:block">
            VIEW ALL →
          </Link>
        </div>
        ...
        <div className="mt-8 sm:hidden">
          <Link href="/new" className="block w-full text-center font-body text-xs tracking-[0.2em] py-3.5 border border-charcoal hover:bg-charcoal hover:text-white transition-colors">
